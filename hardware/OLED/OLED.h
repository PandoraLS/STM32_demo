...
#define GPIO_Pin_CLK	GPIO_Pin_4//SCL  D0
#define GPIO_Pin_MOSI	GPIO_Pin_5//SDA		D1
#define GPIO_Pin_CS		GPIO_Pin_6//RST 	
#define GPIO_Pin_DC		GPIO_Pin_7//DC 
...
void OLED_6x8Str(unsigned char x, unsigned char y, unsigned char ch[]);//显示字符串
void OLED_8x16Str(unsigned char x, unsigned char y, unsigned char ch[]);//显示字符串
void OLED_16x16CN(unsigned char x, unsigned char y, unsigned char N);//显示字符
void OLED_BMP(unsigned char x0, unsigned char y0, unsigned char x1, unsigned char y1, const u8 *BMP);	//图片显示
//void OLED_Print(unsigned char x, unsigned char y, unsigned char ch[]);
void OLED_8x16var(unsigned char x, unsigned char y, unsigned int N);//显示无符号整形数据
void OLED_6x8var(unsigned char x, unsigned char y, unsigned int N);//显示无符号整形数据
void OLED_6x8var_ch(unsigned char x, unsigned char y, int N);//显示有符号整形数据
#endif
