...
{ 	
  ...
  SPI_InitTypeDef  SPI_InitStructure;
	...
	GPIO_InitStructure.GPIO_Pin = GPIO_Pin_13;	//PG8 7 推挽 	  
	...
	GPIO_ResetBits(GPIOB,GPIO_Pin_0);//PG7,8下拉	
	GPIO_ResetBits(GPIOC,GPIO_Pin_13);//PG7,8下拉	
	//nRF24L01 NVIC配置
...
u8 NRF24L01_TxPacket(u8 *txbuf)
{
	...
	EXTI->PR=1<<0;					//清除line6的中断	
	EXTI->IMR|=1<<0;				//发送结束，不屏蔽中断线6。
